...
public class DriveIOSim implements DriveIO {
  ...
  private final SparkMaxSim frontLeftMotorSim = new SparkMaxSim(frontLeftMotor, gearbox);
  private final SparkMaxSim frontRightMotorSim = new SparkMaxSim(frontRightMotor, gearbox);
  private final SparkMaxSim backLeftMotorSim = new SparkMaxSim(backLeftMotor, gearbox);
  private final SparkMaxSim backRightMotorSim = new SparkMaxSim(backRightMotor, gearbox);
  ...
  private final SimpleMotorFeedforward feedforward = new SimpleMotorFeedforward(simKs, simKv);

  private final PIDController frontLeftPIDController = new PIDController(simKp, 0, simKd);
  private final PIDController frontRightPIDController = new PIDController(simKp, 0, simKd);
  private final PIDController backLeftPIDController = new PIDController(simKp, 0, simKd);
  private final PIDController backRightPIDController = new PIDController(simKp, 0, simKd);
  ...
  public void setSpeeds(MecanumDriveWheelSpeeds speeds) {
    ...
    frontLeftMotorSim.iterate(
        frontLeftOutput + frontLeftFeedforward, frontLeftMotorSim.getBusVoltage(), 0.2);
  ...
  public void updateInputs(DriveIOInputs inputs) {
    ...
    inputs.frontLeftAppliedVolts =
        frontLeftMotorSim.getAppliedOutput() * frontLeftMotorSim.getBusVoltage();
    inputs.frontLeftCurrentAmps = frontLeftMotorSim.getMotorCurrent();
    ...
    inputs.frontRightAppliedVolts =
        frontRightMotorSim.getAppliedOutput() * frontRightMotorSim.getBusVoltage();
    inputs.frontRightCurrentAmps = frontRightMotorSim.getMotorCurrent();
    ...
    inputs.backLeftAppliedVolts =
        backLeftMotorSim.getAppliedOutput() * backLeftMotorSim.getBusVoltage();
    inputs.backLeftCurrentAmps = backLeftMotorSim.getMotorCurrent();
    ...
    inputs.backRightAppliedVolts =
        backRightMotorSim.getAppliedOutput() * backRightMotorSim.getBusVoltage();
    inputs.backRightCurrentAmps = backRightMotorSim.getMotorCurrent();
