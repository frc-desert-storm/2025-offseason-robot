...
public class ArmConstants {
  ...
  public static final double extensionMaxAccel = 100;
  public static final double extensionMaxVelo = 200;

  public static final double extensionRealKp = 32.0;
  public static final double extensionRealKd = 0.0;

  public static final double extensionRealKv = 0.0;
  public static final double extensionRealKs = 1.0;
  public static final double extensionRealKa = 0.0;

  public static final double extensionSimKp = 32.0;
